...
- [單元測試的藝術](#單元測試的藝術)
  ...
  - [2.4.3 pg36](#243-pg36)
    - [調整產品程式碼](#調整產品程式碼)
  - [2.5 pg38 使用參數來重構測試](#25-pg38-使用參數來重構測試)
  - [2.6.1 pg42](#261-pg42)
  - [2.6.2 pg45 驗證預期的例外](#262-pg45-驗證預期的例外)
  - [2.6.3 pg 忽略此測試](#263-pg-忽略此測試)
  - [2.7 pg50 測試系統狀態的改變，而非驗證回傳值](#27-pg50-測試系統狀態的改變而非驗證回傳值)
  - [2.7 pg52 pg53](#27-pg52-pg53)
- [3.4.3 pg70](#343-pg70)
- [Futher reading 進階 Mock](#futher-reading-進階-mock)
  - [Mocking in jest](#mocking-in-jest)
  - [Mocking in angular](#mocking-in-angular)
